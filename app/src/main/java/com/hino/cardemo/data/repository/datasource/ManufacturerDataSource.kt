 ...
 * @since 20/12/18
 */
internal class ManufacturerDataSource(val carApiService: CarApiService, val pageSize: Int) : DataSource.Factory<Int, ItemData>() {
    ...
    private fun loadData(callback: ItemKeyedDataSource.LoadCallback<ItemData>) {
        carApiService.getManufacturer(currentPage++, pageSize)
